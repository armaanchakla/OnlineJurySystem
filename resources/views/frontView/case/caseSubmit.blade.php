            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 offset-xl-1 col-md-6 col-md-12 col-lg-6">
                    <div class="appointment_info">
                        ...
                        <h3>Submit Case Here</h3>
                        <h2>{{ Session::get('caseSubmitMessage') }}</h2>
                        <br>
                        	{{ Form::open(['url' => '/case/submit','method' => 'post', 'role' => 'form']) }}
                                <div class="row">
                                    <div class="col-xl-12">
                                            <input type="text" name="caseName" placeholder="Title">
                                    </div>
                                    <div class="col-xl-12">
                                        <textarea name="caseDescription" placeholder="Description" ></textarea>
                                    </div>

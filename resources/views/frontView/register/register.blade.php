                    ...
                    <div class="appointment_info">
                        ...
                        @csrf
                                <div>
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <input name="password" type="password" placeholder="Password" required autocomplete="password">
                                    </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6">
                                        <input name="password_confirmation" type="password" placeholder="Confirm Password" required autocomplete="password_confirmation">
                                    </div>
